    ...
    experiences: [
      {
        ...
        period: "2022 - ներկա",
        desc: "Ստեղծում եմ ժամանակակից վեբ հավելվածներ React-ով, Next.js-ով և TypeScript-ով՝ կարևորելով որակը, հասանելիությունը և օգտագործման հարմարությունը"
      },
      {
        title: "Վեբ ծրագրավորող",
        period: "2020 - 2022",
        desc: "Ստեղծում եմ արձագանքող կայքեր և վեբ հավելվածներ՝ օգտագործելով HTML, CSS, JavaScript և տարբեր տեխնոլոգիաներ։"
      }
    ],
    techCategories: {
      frontend: ["React", "Next.js", "TypeScript", "Tailwind CSS"],
