...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://davitgyulinyan.am/about",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
...
const content = {
  ...
  hy: {
    title: "Իմ մասին",
    subtitle: "Փորձառու ֆրոնտենդ ծրագրավորող՝ մասնագիտացված React և Next.js տեխնոլոգիաներում",
    experience: "Փորձ",
    ...
    experiences: [
      ...
      },
      {
        ...
        period: "28.12.2024 - 23.03.2025",
        desc: "Աշխատել եմ Sol-Dynamis-ի Auxillium նախագծում՝ օգտագործելով React, TypeScript, SCSS և MUI։ Մշակել եմ արձագանքող և հասանելի UI բաղադրիչներ՝ կենտրոնանալով մաքուր կոդի կառուցվածքի, վերօգտագործելի կոմպոնենտների ստեղծման և օպտիմիզացված ոճավորման վրա",
      },
      {
        title: "RateSnap — Անձնական նախագիծ",
        period: "09.07.2024 - 17.10.2024",
        desc: "Կառուցել եմ գլոբալ արժույթի փոխարկիչ վեբ հավելված՝ օգտագործելով Next.js, TypeScript և Material UI։ Հավելվածը թույլ է տալիս փոխարկել աշխարհի բոլոր արժույթները իրական ժամանակի փոխարժեքներով և ստանալ ամենօրյա թարմացումներ։ Այն առաջարկում է արագ արձագանքող և օգտագործողին հարմար ինտերֆեյս՝ արժույթների անխափան փոխարկման համար",
      },
      {
        title: "Ֆրոնտենդ ծրագրավորող IO Development-ում (Հեռավար)",
        period: "03.12.2023 – 06.06.2024",
        desc: "Աշխատել եմ IO Development-ի քննական նախագծի վրա օգտագործելով React.js։ Նախագծել եմ դինամիկ և արձագանքող վեբ հավելված, օգտագործելով իմ React.js-ի գիտելիքները, ստեղծել տարբեր ինտերակտիվ հատկություններ։",
      },
      {
